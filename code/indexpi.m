...
% Last Modified by GUIDE v2.5 01-Feb-2015 16:08:06
...
if r1.pipei/r1.key>0.2 
    if zheng>0.6 && fan<0.2
        set(handles.text15,'string','被检测图像中，互感器正常');
    else if r1.zheng<r1.fan && r1.fan>0.05
            set(handles.text15,'string','被检测图像中，互感器颠倒');
        else
            set(handles.text15,'string','被检测图像中，互感器有可能倾倒');
        end
    end
else 
    set(handles.text15,'string','被检测图像中，互感器有可能倾倒');
